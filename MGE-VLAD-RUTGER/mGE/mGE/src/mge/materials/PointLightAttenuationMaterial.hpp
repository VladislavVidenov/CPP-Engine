#ifndef POINTLIGHTATTENUATIONMATERIAL_H
#define POINTLIGHTATTENUATIONMATERIAL_H
 ...
 */
class PointLightAttenuationMaterial : public AbstractMaterial
{
    public:
        PointLightAttenuationMaterial(glm::vec3 pColor = glm::vec3(1,0,0));
        virtual ~PointLightAttenuationMaterial();
...
#endif // POINTLIGHTATTENUATIONMATERIAL_H

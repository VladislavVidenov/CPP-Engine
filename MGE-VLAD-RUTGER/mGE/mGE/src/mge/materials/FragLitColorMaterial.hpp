#ifndef FRAGLITCOLORMATERIAL_H
#define FRAGLITCOLORMATERIAL_H
 ...
 */
class FragLitColorMaterial : public AbstractMaterial
{
    public:
        FragLitColorMaterial(glm::vec3 pColor = glm::vec3(1,0,0));
        virtual ~FragLitColorMaterial();
